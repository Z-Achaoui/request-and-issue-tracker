    ...
    <Fragment>
      <div className="flex flex-row items-start justify-center w-full">
        ...
        <div className="flex flex-col justify-center items-center w-[6rem]">
          <button className="flex flex-row justify-center items-center mx-2 mb-px p-1 w-full border bg-gray-500 rounded-md shadow-md outline-orange-400  hover:bg-gray-400 text-white text-xs italic">
            <span className="px-2 h-full self-center">Send</span>
            <IoSendOutline className="text-xs" />
          </button>
          <button className="flex flex-row justify-center items-center mx-2 p-0.5 w-full border bg-gray-500 rounded-md shadow-md outline-orange-400  hover:bg-gray-400 text-white text-xs italic">
